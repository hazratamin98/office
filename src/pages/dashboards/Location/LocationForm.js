...
import GoogleMapInpuField from "./GoogleMapInpuField";
...
const LocationForm = ({ theme }) => {
  ...
  console.log("zzz", getSelectedCompanyId + 1);
          ...
          <Formik
            ...
            initialValues={{
              ...
              addressOne:
                ...
                googlePlaceData?.address_components[0]?.long_name
                  ? googlePlaceData?.address_components[0]?.long_name
                  : "",
              addressTwo: "",
              postalCode:
                googlePlaceData &&
                googlePlaceData?.address_components &&
                googlePlaceData?.address_components.slice(-1)[0]?.long_name
                  ? googlePlaceData?.address_components?.slice(-1)[0]?.long_name
                  : "",
              city:
                googlePlaceData &&
                googlePlaceData?.address_components &&
                googlePlaceData?.address_components[6]?.long_name
                  ? googlePlaceData?.address_components[6]?.long_name
                  : "",
              countryName:
                googlePlaceData &&
                ...
                <Grid>
                  <Typography variant="h4" p={7}>
                    ...
                    <Typography variant="subtitle1">
                      Pre-filled by Google Business Profile, modify if needed
                    </Typography>
                  </Typography>
                  <Grid container>
