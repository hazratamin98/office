...
const AddUser = ({ onCancel, id, Language, Role, theme }) => {
            ...
            onSubmit={async (
              ...
              try {
                ...
                const res = await axios.post(
                  `http://ec2-35-165-226-126.us-west-2.compute.amazonaws.com/api/v1/user/addUser`,
                  {
                    firstName: values.firstName,
                    lastName: values.lastName,
                    email: values.email,
                    language: values.languageName,
                    // role: values.roleName.toLowerCase(),
                    companyId: id.id,
                  },
                  config
                );
                if (res.status == 200) {
                  // setIsLoading(false);
                  console.log("helooooo", res.data.data);
